...
public class DataSource {
    ...
    public static final String CONNECTION_STRING="jdbc:sqlite:E:\\JavaCourse\\Music\\"+DB_NAME;
    ...
    public static final String QUERY_VIEW_SONG_INFO="SELECT "+COLUMN_ARTIST_NAME+", "+COLUMN_ALBUM_NAME+", "
    ...
    public static final String QUERY_ARTIST="SELECT "+COLUMN_ARTIST_NAME+" FROM "+TABLE_ARTISTS
            +" WHERE "+COLUMN_ARTIST_NAME+"=?";
    public static final String QUERY_ALBUM="SELECT "+COLUMN_ALBUM_NAME+" FROM "+TABLE_ALBUMS
    ...
    public void close(){
        try{
            ...
            if(querySongInfoView!=null){
                this.querySongInfoView.close();
            }
            if(this.conn!=null){
                this.conn.close();
            }
        }catch(SQLException e){
            System.out.println("Could't close the database "+e.getMessage());
        }
    }
    ...
    public List<Album>  queryAlbumsForArtistId(int id){
        try{
            queryAlbumsByArtist.setInt(1,id);
    ...
    public void insertSong(String title,String artist ,String album,int track){
        ...
        try{
            ...
            try{
                System.out.println("Pereforming a rollback");
                conn.rollback();
            }catch(SQLException e2){
                System.out.println("Oh boy ! Things are really bad "+e2.getMessage());
            }finally {
                try{
                    System.out.println("Resetting the autocommit behaviour");
                    conn.setAutoCommit(true);
                }catch(SQLException e3){
                    System.out.println("Could't reset the autocommit "+e3.getMessage());
                }
